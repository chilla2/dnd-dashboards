...
return [
    ...
    'dashboard_index' => [[], ['_controller' => 'App\\Controller\\DashboardController::index'], [], [['text', '/dashboards/']], [], []],
    'player_display' => [[], ['_controller' => 'App\\Controller\\DashboardController::playerDisplay'], [], [['text', '/dashboards/player-display']], [], []],
    'player_display_control' => [[], ['_controller' => 'App\\Controller\\DashboardController::playerDisplayControl'], [], [['text', '/dashboards/player-display-control']], [], []],
    'combat_mode' => [[], ['_controller' => 'App\\Controller\\DashboardController::combatMode'], [], [['text', '/dashboards/player-display-control/combat-mode']], [], []],
    'player_display_show' => [['object', 'id'], ['_controller' => 'App\\Controller\\DashboardController::showPlayers'], [], [['text', '/show-hide'], ['variable', '/', '[^/]++', 'id', true], ['variable', '/', '[^/]++', 'object', true], ['text', '/dashboards/player-display-control']], [], []],
    'player_hide_all' => [[], ['_controller' => 'App\\Controller\\DashboardController::hideAll'], [], [['text', '/dashboards/player-display-control/hide-all']], [], []],
    'dashboard_new' => [[], ['_controller' => 'App\\Controller\\DashboardController::new'], [], [['text', '/dashboards/new']], [], []],
