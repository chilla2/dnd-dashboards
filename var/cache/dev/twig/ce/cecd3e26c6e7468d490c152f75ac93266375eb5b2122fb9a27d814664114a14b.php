...
class __TwigTemplate_ec3fc7dc68df5c9ea6b5c0f3f602576052fc28ce1a390d3f22a6f3a856551f5c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row bg-dark\"> <!--  start row 1 of grid 1 -->
        <div class=\"col-sm-3 bg-dark\"> <!--  start of col 1 of grid 1 -->
            <div class=\"container-sm p-0 m-0 bg-dark\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["player"]) {
            ...
            // line 22
            echo "                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#";
        ...
        echo "                                </ul>
                    ...
                    <div class=\"accordion-item\">
                        ...
                        <div id=\"flush-collapseTwo\" class=\"accordion-collapse collapse bg-dark text-white\" aria-labelledby=\"flush-headingTwo\" data-bs-parent=\"#accordionFlushExample\">
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ";
        // line 37
        ...
        echo "                                </ul>
                    ...
                    <div class=\"accordion-item\">
                        ...
                        <div id=\"flush-collapseThree\" class=\"accordion-collapse collapse bg-dark text-white\" aria-labelledby=\"flush-headingThree\" data-bs-parent=\"#accordionFlushExample\">
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ";
        // line 54
        ...
        echo "                                </ul>
                    ...
                    <div class=\"accordion-item\">
                        ...
                        <div id=\"flush-collapseFour\" class=\"accordion-collapse collapse bg-dark text-white\" aria-labelledby=\"flush-headingFour\" data-bs-parent=\"#accordionFlushExample\">
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ";
        // line 71
        ...
        echo "                                </ul>
                    ...
                    <div class=\"accordion-item\">
                        ...
                        <div id=\"flush-collapseFive\" class=\"accordion-collapse collapse bg-dark text-white\" aria-labelledby=\"flush-headingFive\" data-bs-parent=\"#accordionFlushExample\">
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ";
        // line 88
        ...
        echo "                                </ul>
                    ...
                    <div class=\"accordion-item\">
                        ...
                        <div id=\"flush-collapseSix\" class=\"accordion-collapse collapse bg-dark text-white\" aria-labelledby=\"flush-headingSix\" data-bs-parent=\"#accordionFlushExample\">
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ";
        // line 105
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["other"]) {
            ...
            // line 107
            echo "                                        <li class=\"list-group-item list-group-item-action m-0 p-0 bg-dark text-white\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#";
        ...
        <div class=\"col-sm-8\"> <!--  start col 2 of grid 1 and start of grid 2 -->
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set playernames = player.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ playernames|join('-') }}\">{{ player.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set npcnames = npc.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ npcnames|join('-') }}\">{{ npc.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set creaturenames = creature.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ creaturenames|join('-') }}\">{{ creature.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set locationnames = location.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ locationnames|join('-') }}\">{{ location.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set itemnames = item.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action bg-dark text-white m-0 p-0\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ itemnames|join('-') }}\">{{ item.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class=\"accordion-body p-0\">
                                <ul class=\"list-group\">
                                    ...
                                    {% set othernames = other.name|split(' ') %}
                                        <li class=\"list-group-item list-group-item-action m-0 p-0 bg-dark text-white\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#{{ othernames|join('-') }}\">{{ other.name }}</li>
                                    {% endfor %}
                                </ul>
                            </div>
                        </div>
