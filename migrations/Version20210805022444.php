 ...
 */
final class Version20210805022444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, name, show_players, description, notes, initiative FROM creature');
        ...
        $this->addSql('INSERT INTO creature (id, name, show_players, description, notes, initiative) SELECT id, name, show_players, description, notes, initiative FROM __temp__creature');
        $this->addSql('DROP TABLE __temp__creature');
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, name, show_players, description, notes FROM item');
        ...
        $this->addSql('INSERT INTO item (id, name, show_players, description, notes) SELECT id, name, show_players, description, notes FROM __temp__item');
        $this->addSql('DROP TABLE __temp__item');
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, name, show_players, description, notes FROM location');
        ...
        $this->addSql('INSERT INTO location (id, name, show_players, description, notes) SELECT id, name, show_players, description, notes FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE TEMPORARY TABLE __temp__npc AS SELECT id, name, show_players, description, notes, link, initiative FROM npc');
        ...
        $this->addSql('INSERT INTO npc (id, name, show_players, description, notes, link, initiative) SELECT id, name, show_players, description, notes, link, initiative FROM __temp__npc');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE creature');
        $this->addSql('CREATE TABLE creature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, show_players BOOLEAN NOT NULL)');
        ...
        $this->addSql('DROP TABLE npc');
        $this->addSql('CREATE TABLE npc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, link CLOB DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, show_players BOOLEAN NOT NULL)');
