 ...
 */
final class Version20210819191602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character ADD COLUMN is_enemy BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE creature ADD COLUMN is_enemy BOOLEAN DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE npc ADD COLUMN is_enemy BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE character (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, damage INTEGER DEFAULT NULL, initiative INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        ...
        $this->addSql('CREATE TABLE npc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, link CLOB DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, initiative INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL)');
