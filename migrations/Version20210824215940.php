 ...
 */
final class Version20210824215940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__other AS SELECT id, heading, show_players, description, notes, updated_at, image_name, show_dm FROM other');
        $this->addSql('DROP TABLE other');
        $this->addSql('CREATE TABLE other (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, heading VARCHAR(255) NOT NULL COLLATE BINARY, show_players BOOLEAN DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY, notes CLOB DEFAULT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO other (id, heading, show_players, description, notes, updated_at, image_name, show_dm) SELECT id, heading, show_players, description, notes, updated_at, image_name, show_dm FROM __temp__other');
    ...
    public function down(Schema $schema): void
    {
        ...
        , notes CLOB DEFAULT NULL COLLATE BINARY, resources CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:array)
        )');
        $this->addSql('DROP INDEX IDX_C53FC3EED6E2FADC');
        $this->addSql('DROP INDEX IDX_C53FC3EE1136BE75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter_character AS SELECT encounter_id, character_id FROM encounter_character');
        ...
        $this->addSql('DROP TABLE other');
        $this->addSql('CREATE TABLE other (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, heading VARCHAR(255) NOT NULL, description CLOB NOT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, image_name VARCHAR(255) NOT NULL COLLATE BINARY)');
