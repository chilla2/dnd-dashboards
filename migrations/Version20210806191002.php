 ...
 */
final class Version20210806191002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dash (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, combat_mode BOOLEAN DEFAULT NULL)');
        $this->addSql('DROP TABLE dashboard');
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, name, description, notes, initiative, show_players, armor_class, hp, initiative_roll, conditions, updated_at, image_name FROM creature');
        ...
        $this->addSql('INSERT INTO creature (id, name, description, notes, initiative, show_players, armor_class, hp, initiative_roll, conditions, updated_at, image_name) SELECT id, name, description, notes, initiative, show_players, armor_class, hp, initiative_roll, conditions, updated_at, image_name FROM __temp__creature');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM item');
        ...
        $this->addSql('INSERT INTO item (id, name, description, notes, show_players, image_file_name, updated_at, image_name) SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM __temp__item');
        $this->addSql('DROP TABLE __temp__item');
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM location');
        ...
        $this->addSql('INSERT INTO location (id, name, description, notes, show_players, image_file_name, updated_at, image_name) SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE TEMPORARY TABLE __temp__npc AS SELECT id, name, description, notes, link, initiative, show_dm, show_players, image_file_name, armor_class, hp, initiative_roll, conditions, updated_at, image_name FROM npc');
        ...
        , updated_at DATETIME DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO npc (id, name, description, notes, link, initiative, show_dm, show_players, image_file_name, armor_class, hp, initiative_roll, conditions, updated_at, image_name) SELECT id, name, description, notes, link, initiative, show_dm, show_players, image_file_name, armor_class, hp, initiative_roll, conditions, updated_at, image_name FROM __temp__npc');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dashboard (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, combat_mode BOOLEAN DEFAULT NULL)');
        $this->addSql('DROP TABLE dash');
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, name, description, notes, show_players, initiative, updated_at, image_name, armor_class, hp, initiative_roll, conditions FROM creature');
        $this->addSql('DROP TABLE creature');
        $this->addSql('CREATE TABLE creature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, updated_at DATETIME DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, initiative_roll INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO creature (id, name, description, notes, show_players, initiative, updated_at, image_name, armor_class, hp, initiative_roll, conditions) SELECT id, name, description, notes, show_players, initiative, updated_at, image_name, armor_class, hp, initiative_roll, conditions FROM __temp__creature');
        $this->addSql('DROP TABLE __temp__creature');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, combat_mode, combat_encounter, updated_at, image_name FROM game');
        $this->addSql('DROP TABLE game');
        ...
        , updated_at DATETIME DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO game (id, combat_mode, combat_encounter, updated_at, image_name) SELECT id, combat_mode, combat_encounter, updated_at, image_name FROM __temp__game');
        $this->addSql('DROP TABLE __temp__game');
        $this->addSql('CREATE TEMPORARY TABLE __temp__item AS SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM item');
        $this->addSql('DROP TABLE item');
        ...
        $this->addSql('INSERT INTO location (id, name, description, notes, show_players, image_file_name, updated_at, image_name) SELECT id, name, description, notes, show_players, image_file_name, updated_at, image_name FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE TEMPORARY TABLE __temp__npc AS SELECT id, name, description, notes, show_players, link, initiative, show_dm, image_file_name, updated_at, image_name, armor_class, hp, initiative_roll, conditions FROM npc');
        $this->addSql('DROP TABLE npc');
        $this->addSql('CREATE TABLE npc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, link CLOB DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, image_file_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, initiative_roll INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO npc (id, name, description, notes, show_players, link, initiative, show_dm, image_file_name, updated_at, image_name, armor_class, hp, initiative_roll, conditions) SELECT id, name, description, notes, show_players, link, initiative, show_dm, image_file_name, updated_at, image_name, armor_class, hp, initiative_roll, conditions FROM __temp__npc');
        $this->addSql('DROP TABLE __temp__npc');
