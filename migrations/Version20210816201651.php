 ...
 */
final class Version20210816201651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter AS SELECT id, name, combatants FROM encounter');
        $this->addSql('DROP TABLE encounter');
        $this->addSql('CREATE TABLE encounter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, combatants CLOB DEFAULT NULL --(DC2Type:array)
        )');
        $this->addSql('INSERT INTO encounter (id, name, combatants) SELECT id, name, combatants FROM __temp__encounter');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter AS SELECT id, name, combatants FROM encounter');
        $this->addSql('DROP TABLE encounter');
        $this->addSql('CREATE TABLE encounter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, combatants CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO encounter (id, name, combatants) SELECT id, name, combatants FROM __temp__encounter');
        $this->addSql('DROP TABLE __temp__encounter');
        $this->addSql('DROP INDEX IDX_C53FC3EED6E2FADC');
        $this->addSql('DROP INDEX IDX_C53FC3EE1136BE75');
