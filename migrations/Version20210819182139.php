 ...
 */
final class Version20210819182139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, name, initiative, description, notes, armor_class, hp, damage, conditions, image_name, image_size, updated_at, show_dm FROM character');
        $this->addSql('DROP TABLE character');
        $this->addSql('CREATE TABLE character (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, notes CLOB DEFAULT NULL COLLATE BINARY, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, damage INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_size INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO character (id, name, initiative, description, notes, armor_class, hp, damage, conditions, image_name, image_size, updated_at, show_dm) SELECT id, name, initiative, description, notes, armor_class, hp, damage, conditions, image_name, image_size, updated_at, show_dm FROM __temp__character');
        $this->addSql('DROP TABLE __temp__character');
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, name, description, notes, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm FROM creature');
        ...
        , updated_at DATETIME DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_size INTEGER DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO creature (id, name, description, notes, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm) SELECT id, name, description, notes, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm FROM __temp__creature');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__npc AS SELECT id, name, description, notes, link, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm FROM npc');
        $this->addSql('DROP TABLE npc');
        $this->addSql('CREATE TABLE npc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, notes CLOB DEFAULT NULL COLLATE BINARY, link CLOB DEFAULT NULL COLLATE BINARY, show_players BOOLEAN DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:array)
        , updated_at DATETIME DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_size INTEGER DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO npc (id, name, description, notes, link, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm) SELECT id, name, description, notes, link, initiative, show_players, armor_class, hp, conditions, updated_at, image_name, image_size, show_dm FROM __temp__npc');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, name, description, notes, armor_class, hp, damage, initiative, conditions, image_name, image_size, updated_at, show_dm FROM character');
        $this->addSql('DROP TABLE character');
        $this->addSql('CREATE TABLE character (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, damage INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative BOOLEAN NOT NULL, initiative_roll INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO character (id, name, description, notes, armor_class, hp, damage, initiative, conditions, image_name, image_size, updated_at, show_dm) SELECT id, name, description, notes, armor_class, hp, damage, initiative, conditions, image_name, image_size, updated_at, show_dm FROM __temp__character');
        $this->addSql('DROP TABLE __temp__character');
        $this->addSql('CREATE TEMPORARY TABLE __temp__creature AS SELECT id, name, description, notes, show_players, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm FROM creature');
        $this->addSql('DROP TABLE creature');
        $this->addSql('CREATE TABLE creature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, initiative_roll INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO creature (id, name, description, notes, show_players, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm) SELECT id, name, description, notes, show_players, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm FROM __temp__creature');
        $this->addSql('DROP TABLE __temp__creature');
        $this->addSql('DROP INDEX IDX_C53FC3EED6E2FADC');
        $this->addSql('DROP INDEX IDX_C53FC3EE1136BE75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter_character AS SELECT encounter_id, character_id FROM encounter_character');
        ...
        $this->addSql('CREATE INDEX IDX_A2EB62BAD6E2FADC ON encounter_npc (encounter_id)');
        $this->addSql('CREATE INDEX IDX_A2EB62BACA7D6B89 ON encounter_npc (npc_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__npc AS SELECT id, name, description, notes, show_players, link, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm FROM npc');
        $this->addSql('DROP TABLE npc');
        $this->addSql('CREATE TABLE npc (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, notes CLOB DEFAULT NULL, show_players BOOLEAN DEFAULT NULL, link CLOB DEFAULT NULL, armor_class INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, conditions CLOB DEFAULT NULL --(DC2Type:array)
        , image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, show_dm BOOLEAN DEFAULT NULL, initiative BOOLEAN DEFAULT NULL, initiative_roll INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO npc (id, name, description, notes, show_players, link, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm) SELECT id, name, description, notes, show_players, link, armor_class, hp, initiative, conditions, image_name, image_size, updated_at, show_dm FROM __temp__npc');
        $this->addSql('DROP TABLE __temp__npc');
        $this->addSql('DROP INDEX UNIQ_F454B6729EE1950E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__private_dashboard AS SELECT id, public_dashboard_id, combat_mode, events FROM private_dashboard');
        $this->addSql('DROP TABLE private_dashboard');
