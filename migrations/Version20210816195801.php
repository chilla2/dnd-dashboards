 ...
 */
final class Version20210816195801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter AS SELECT id, name FROM encounter');
        $this->addSql('DROP TABLE encounter');
        $this->addSql('CREATE TABLE encounter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO encounter (id, name) SELECT id, name FROM __temp__encounter');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encounter ADD COLUMN combatants CLOB DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_C53FC3EED6E2FADC');
        $this->addSql('DROP INDEX IDX_C53FC3EE1136BE75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__encounter_character AS SELECT encounter_id, character_id FROM encounter_character');
        $this->addSql('DROP TABLE encounter_character');
